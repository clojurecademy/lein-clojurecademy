(ns leiningen.clojurecademy.http.core-old
  "Core HTTP request/response implementation."
  (:require [leiningen.clojurecademy.http.conn-mgr :as conn]
            [leiningen.clojurecademy.http.headers :as headers]
            [leiningen.clojurecademy.http.multipart :as mp]
            [leiningen.clojurecademy.http.util :refer [opt]]
            [clojure.pprint])
